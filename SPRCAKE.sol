...
contract SPRCAKE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SuperCake", "SPRCAKE") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0xe86Bf18940DD9527FC8C100Fdf81C188fa08f850;
